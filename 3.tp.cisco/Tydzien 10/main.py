...
ocena_celnosci = lambda hs_percent: "Wyborny strzelec" if hs_percent >=50 else "Zwykły gracz"
...
gracze_na_plusie = list(filter(lambda gracz: gracz["kd_ratio"] > 1.0, gracze))
...
gracze.sort(key= lambda pracze: pracze["adr"], reverse=True)
