...
## **Część 1: Struktura HTML**
1. Utwórz formularz (`<form>`) zawierający dwa pola wejściowe (`<input type="text">`): jedno przeznaczone na imię, drugie na ulubiony kolor.
2. Dodaj przycisk wysyłający formularz (`<button type="submit">`).
3. Poniżej formularza umieść pusty element tekstowy (np. `<p>` lub `<div>`), w którym zostanie wyświetlony ostateczny wynik.
