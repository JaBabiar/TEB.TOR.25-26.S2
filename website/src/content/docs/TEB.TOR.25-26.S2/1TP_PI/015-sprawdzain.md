---
title: "Sprawdzian Praktyczny INF.03 - Front-End (Grupa B)"
course: "TEB.TOR.25-26"
layout: ../layouts/ExamLayout.astro
---

# Zadanie Egzaminacyjne: Aplikacja "Kalkulator Projektu Stron WWW"

## Instrukcja dla zdającego
Twoim zadaniem jest wykonanie aplikacji internetowej dla agencji interaktywnej. Utwórz kod HTML, CSS oraz JavaScript. Pliki zapisz pod nazwami: `index.html`, `styl.css`, `skrypt.js` i połącz je w logiczną całość. 
...
- Struktura strony musi składać się z:
  ...
  - Kontenera głównego, a w nim:
    ...
    - Bloku prawego.
  - Stopki.
- W bloku lewym utwórz formularz wyceny projektu zawierający:
  - Etykietę o treści "Nazwa firmy / Klient:" z powiązanym polem tekstowym.
  - Etykietę o treści "Liczba projektowanych podstron:" z powiązanym polem liczbowym (`<input type="number">`).
...
- Oprogramuj poniższą logikę:
  - Jeżeli pole liczby podstron jest puste lub wartość jest mniejsza niż 1, wyświetl pod formularzem komunikat o błędzie: *"Błąd: Wprowadź poprawną liczbę podstron!"*.
  - Jeśli dane są poprawne, pomnóż liczbę podstron przez bazową stawkę za jedną podstronę wynoszącą `200 zł`.
  - Wyświetl w przygotowanym obszarze (w bloku prawym) wynik wg wzoru: 
    *"Klient: [Nazwa firmy / Klient], szacowany koszt wykonania [Liczba] podstron wynosi: [Wynik] PLN."*
