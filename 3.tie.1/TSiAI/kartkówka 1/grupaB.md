...
3. Pole numeryczne na **Liczbę stron**.
...
`Książka: <tytuł książki>, autorstwa: <autor książki>, posiada stron: <liczba stron>`

> ⭐ **Zadanie dodatkowe (na ocenę celującą - 6):**
> Rozbuduj walidację (sprawdzanie) z punktu 2. Zanim skrypt wypisze wynik na stronie, sprawdź, czy wpisana liczba stron jest logicznie poprawna, czyli czy jej wartość jest większa lub równa 1 **oraz** mniejsza lub równa 1500. Jeśli liczba stron nie mieści się w tym przedziale, skrypt nie powinien wyświetlać wyniku.